...
export const EditUserStoryModal = ({ isOpen, onClose, story, onStoryUpdated }) => {
      ...
      <div style={{
        ...
        <div className="glass-card animate-fade-in" style={{
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', marginBottom: '20px' }}>
            Only Project Managers, Business Analysts, and Administrators can modify user story specifications.
          </p>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await requirementApi.updateUserStory(story.storyId, {
      ...
      let msg = err.response?.data?.message || err.message || 'Failed to update user story.';
      ...
      <div className="glass-card animate-fade-in" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h2 style={{ fontSize: '1.25rem', margin: 0 }}>Edit User Story</h2>
              <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                STORY-00{story.storyId} • Parent: {story.requirementTitle || `REQ #${story.requirementId}`}
              </span>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label className="form-label" htmlFor="edit-story-title">
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="edit-story-acceptance">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '22px' }}>
            <div className="form-group" style={{ margin: 0 }}>
              <label className="form-label" htmlFor="edit-story-priority">Priority</label>
              <select
            ...
            <div className="form-group" style={{ margin: 0 }}>
              <label className="form-label" htmlFor="edit-story-status">Status</label>
              <select
